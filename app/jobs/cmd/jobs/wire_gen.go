...
func wireApp(confServer *conf.Server, confData *conf.Data, app *conf.App, registry *conf.Registry, discovery *conf.Discovery, msgReadHandler *conf.MsgReadHandler, logger log.Logger) (*kratos.App, func(), error) {
